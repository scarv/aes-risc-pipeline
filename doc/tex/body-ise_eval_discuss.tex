...
\hline
 ...
 RV32IMC & \ISE{1} (L) &        3514  & \bftab 18  &       41671  ($1.  \times$) &       3508448 ($1.002\times$) \\
 RV32IMC & \ISE{1} (A) &        2195  &        21  &       40109  ($1.  \times$) &       3506995 ($1.002\times$) \\
 RV32IMC & \ISE{2} (L) &        3574  &        19  &       41134  ($1.  \times$) &       3508946 ($1.002\times$) \\
 RV32IMC & \ISE{2} (A) &        1355  &        21  &       38829  ($1.  \times$) &\bftab 3506591 ($1.001\times$) \\
 RV32IMC & \ISE{3}     & \bftab 1149  &        30  &\bftab 38608  ($1.  \times$) &       3506761 ($1.001\times$) \\
 RV32IMC & \ISE{5} (L) &        4172  &        21  &       39213  ($1.  \times$) &       3510055 ($1.002\times$) \\
 RV32IMC & \ISE{5} (A) &        1726  &        23  &       42032  ($1.  \times$) &       3507755 ($1.002\times$) \\
\hline
\hline
  \multicolumn{1}{|c|}{ISA}
& \multicolumn{1}{ c|}{Variant}
...
\hline
 RV32IMC & Baseline    &              &            &       37375  ($1.00\times$) &       3501576 ($1.000\times$) \\
 RV32IMC & \ISE{1} (L) &        1605  & \bftab 17  &              ($    \times$) &               ($     \times$) \\
 RV32IMC & \ISE{1} (A) &        1038  &        23  &              ($    \times$) &               ($     \times$) \\
 RV32IMC & \ISE{2} (L) &        1611  & \bftab 17  &              ($    \times$) &               ($     \times$) \\
 RV32IMC & \ISE{2} (A) &         780  &        21  &              ($    \times$) &               ($     \times$) \\
 RV32IMC & \ISE{3}     & \bftab  630  &        25  &              ($    \times$) &               ($     \times$) \\
 RV32IMC & \ISE{5} (L) &        1852  &        23  &              ($    \times$) &               ($     \times$) \\
 RV32IMC & \ISE{5} (A) &        1048  &        23  &              ($    \times$) &               ($     \times$) \\
\hline
\hline
  \multicolumn{1}{|c|}{ISA}
& \multicolumn{1}{ c|}{Variant}
