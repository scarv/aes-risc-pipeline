...
\hline
\end{tabular}
\caption{Comparison of performance/area product. Each value is normalised to the largest product per column. The {\tt RV64IMC} row is not normalised as there is no comparison point.}
