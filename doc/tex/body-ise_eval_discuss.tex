...
\hline
 ...
 RV32IMC & \ISE{1} (L) &        3472  & \bftab 19  &       41723  ($1.12\times$) &       3508448 ($1.002\times$) \\
 RV32IMC & \ISE{1} (A) &        2174  &        22  &       40161  ($1.07\times$) &       3506995 ($1.002\times$) \\
 RV32IMC & \ISE{2} (L) &        3547  & \bftab 19  &       41199  ($1.10\times$) &       3508946 ($1.002\times$) \\
 RV32IMC & \ISE{2} (A) &        1381  &        21  &       38885  ($1.04\times$) &\bftab 3506591 ($1.001\times$) \\
 RV32IMC & \ISE{3}     & \bftab 1157  &        30  &\bftab 38610  ($1.03\times$) &       3506761 ($1.001\times$) \\
 RV32IMC & \ISE{5} (L) &        4121  &        22  &       42070  ($1.13\times$) &       3510055 ($1.002\times$) \\
 RV32IMC & \ISE{5} (A) &        1927  &        23  &       39251  ($1.05\times$) &       3507755 ($1.002\times$) \\
\hline
\hline
  \multicolumn{1}{|c|}{ISA}
& \multicolumn{1}{ c|}{Variant}
...
\hline
 RV32IMC & Baseline    &              &            &       37375  ($1.00\times$) &       3501576 ($1.000\times$) \\
 RV32IMC & \ISE{1} (L) &        1542  &        18  &              ($    \times$) &               ($     \times$) \\
 RV32IMC & \ISE{1} (A) &         794  &        21  &              ($    \times$) &               ($     \times$) \\
 RV32IMC & \ISE{2} (L) &        1621  & \bftab 17  &              ($    \times$) &               ($     \times$) \\
 RV32IMC & \ISE{2} (A) & \bftab  630  &        20  &              ($    \times$) &               ($     \times$) \\
 RV32IMC & \ISE{3}     & \bftab  630  &        25  &              ($    \times$) &               ($     \times$) \\
 RV32IMC & \ISE{5} (L) &        1853  &        23  &              ($    \times$) &               ($     \times$) \\
 RV32IMC & \ISE{5} (A) &         910  &        22  &              ($    \times$) &               ($     \times$) \\
\hline
\hline
  \multicolumn{1}{|c|}{ISA}
& \multicolumn{1}{ c|}{Variant}
