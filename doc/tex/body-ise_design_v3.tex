...
allows for a more efficient functional unit than \ISE{1} or \ISE{2}, for
...
and
$16$ \VERB{saes.v3.encsm} instructions to apply \AESFUNC{SubBytes}, \AESFUNC{ShiftRows}, \AESFUNC{MixColumns}, and \AESFUNC{AddRoundKey}.
