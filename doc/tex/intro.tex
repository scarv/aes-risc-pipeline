...
in the base      ISA,
and thereby deliver improvement wrt. pertinent quality metrics.  Various
generations of Intel
MultiMedia      eXtensions (MMX),
Streaming SIMD  Extensions (SSE),
and
Advanced Vector Extensions (AVX)
arguably offer the archetypal example of ISEs in practice, each of which 
...
extension to x86 provides a pertinent case-study wrt. these guidelines: 
it affords significant improvement wrt. latency and throughput
