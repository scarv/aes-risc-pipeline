...
2) implement and evaluate $5$ different ISEs for AES,
...
\subsubsection{Variant 1 (\ISE{1}): column-wise acceleration}
\label{sec:ise:design:v1}
\input{tex/body-ise_design_v1.tex}
\subsubsection{Variant 2 (\ISE{2}): combined row/column acceleration}
\label{sec:ise:design:v2}
\input{tex/body-ise_design_v2.tex}
\subsubsection{Variant 3 (\ISE{3}): T-tables acceleration}
\label{sec:ise:design:v3}
\input{tex/body-ise_design_v3.tex}
\subsubsection{Variant 4 (\ISE{4}): $64$-bit}
