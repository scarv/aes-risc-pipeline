...
\author{Ben Marshall \and Dan Page}
\institute{Department of Computer Science, University of Bristol, \\ Merchant Venturers Building, Woodland Road, \\ Bristol, BS8 1UB, United Kingdom. \\ \email{{ben.marshall,daniel.page}@bristol.ac.uk}}
}%
...
\input{tex/eval-hw.tex}
\input{tex/eval-sw.tex}
